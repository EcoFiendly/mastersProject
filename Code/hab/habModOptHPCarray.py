...
npmi = CoherenceModel(model = model, corpus = habCorpus, texts = habTokens3, coherence = 'c_npmi', processes = 8)
...
with open("/rds/general/user/yl4220/home/Data/hab/habNpmi"+str(iter)+".pkl", "wb") as f:
